...
2. Use TypeScript’s type narrowing features (like `typeof` or custom type guards) to handle each type appropriately:
...
- Try creating your own type guard for a custom object type (like an interface or class) and use it in a function.
- Experiment with handling arrays that contain both strings and numbers—how can you safely process each element?
